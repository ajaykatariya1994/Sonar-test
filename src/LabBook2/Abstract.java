...
public class Lab2a extends Account {

	public Lab2a(long accNum, double balance, Human accHolder) {
	...
	public static void main(String[] args) {
		...
		Account a1=new Lab2a(count.incrementAndGet(),2000,h1);
		
		Human h2=new Human("Kathy",22);
		Account a2=new Lab2a(count.incrementAndGet(),3000,h2);
